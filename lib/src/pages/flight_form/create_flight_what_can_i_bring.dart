...
class CreateAdWhatCanIBring extends StatefulWidget {
  @override
  _CreateAdWhatCanIBringState createState() => _CreateAdWhatCanIBringState();
}

class _CreateAdWhatCanIBringState extends State<CreateAdWhatCanIBring> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Container(
                        child: Text(adsText.whatCanIBring(),
                            style: TextStyle(
