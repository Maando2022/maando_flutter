...
class DetailFlightHome extends StatefulWidget {
  @override
  _DetailFlightHomeState createState() => _DetailFlightHomeState();
}

class _DetailFlightHomeState extends State<DetailFlightHome> {
  ...
  Widget build(BuildContext context) {
    ...
    aiports.forEach((country) {
      if (flight["user"]["country"] == country["name"]) {
        phoneCode =
            '+(${country["indicative-code"]}) ${flight["user"]["phone"]}';
        phoneWhatsApps =
            '+${country["indicative-code"]}${flight["user"]["phone"]}';
      }
    });
              ...
              builder: (BuildContext context, AsyncSnapshot<bool> snapshopt) {
                if (snapshopt.hasData) {
                  if (snapshopt.data == true) {
                    return _scaffold2(context, responsive, height, width);
                  } else {
                    return _scaffold1(context, responsive, height, width);
                  }
  ...
  Widget _scaffold1(BuildContext context, Responsive responsive, double height, double width){
    return Scaffold(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontWeight: FontWeight.bold, fontSize: responsive.ip(3.5)),
                      ),
                    ),
                    Container(
  ...
  Widget _scaffold2(BuildContext context, Responsive responsive, double height, double width){
    return Scaffold(
