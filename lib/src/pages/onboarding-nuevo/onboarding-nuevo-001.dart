...
class OnboardingNuevo001Page extends StatelessWidget {
  const OnboardingNuevo001Page({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onDoubleTap: () {
        Navigator.pushReplacementNamed(context, 'omb_new_002');
      },
      child: Scaffold(
...
Widget _parrafo(BuildContext context) {
  return Container(
    ...
    child: Text(
        'New delivery application is \n looking for potentially fun and \nkind people.',
...
Widget _imagen_ppal(BuildContext context) {
  return Container(
      ...
      child: Image.asset('assets/images/onboarding/Frame@3x.png')
      // EdgeInsets.symmetric(
      //     horizontal: variableGlobal.margenPageWithLoginCreateAccount(context)),
